-- extracted from the game using `/c game.write_file("defines.lua", serpent.block(defines))`
-- in the future, either automate this OR (and this is probably the best way) simply make
-- this project into an actual mod that can simply access defines and util functions
-- (and therefore output into script-output, not this directory)
